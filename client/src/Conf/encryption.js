...
const NodeRSA = require('node-rsa'); // Assuming you're using Node.js on the client-side or bundling with a tool like Webpack
...
function Enc_Message_PublicKey(message, recipientPublicKey) {
